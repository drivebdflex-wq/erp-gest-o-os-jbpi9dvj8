...
export type Database = {
  ...
  public: {
    Tables: {
      ...
      contratos: {
        Row: {
          ...
          data_fixa_medicao: number | null
          data_inicio: string | null
          id: string
          nome_contrato: string | null
          numero_contrato: string | null
          possui_medicao: boolean | null
          possui_preventiva: boolean | null
          status: string | null
      ...
      project_finance: {
        Row: {
          ...
          type: Database['public']['Enums']['project_finance_type']
          updated_at: string | null
        }
        Insert: {
          amount?: number | null
      ...
      project_stages: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: 'project_stages_responsible_id_fkey'
    ...
    Enums: {
      ...
      project_finance_type: 'purchase' | 'operational_cost' | 'revenue' | 'misc_expense'
      project_status: 'planejamento' | 'mobilização' | 'execução' | 'finalização' | 'concluída'
...
//   nome_contrato: text (nullable)
//   cliente: text (nullable)
//   tipo_contrato: text (nullable)
//   possui_preventiva: boolean (nullable, default: false)
//   possui_medicao: boolean (nullable, default: false)
//   data_fixa_medicao: integer (nullable)
//   valor_contrato: numeric (nullable)
...
//   nome_etapa: text (nullable)
//   responsavel: text (nullable)
//   data_inicio: date (nullable)
//   data_fim: date (nullable)
//   percentual_execucao: numeric (nullable, default: 0)
...
//   nome_obra: text (nullable)
//   cliente: text (nullable)
//   endereco: text (nullable)
//   responsavel_tecnico: text (nullable)
//   art: text (nullable)
//   data_inicio: date (nullable)
//   data_termino: date (nullable)
//   valor_total: numeric (nullable)
//   status: text (nullable)
//   progresso_geral: numeric (nullable, default: 0)
//   created_at: timestamp without time zone (nullable, default: now())
...
//   prefixo_unidade: text (nullable)
//   descricao_servico: text (nullable)
//   solicitante: text (nullable)
//   tecnico_responsavel: text (nullable)
//   prioridade: text (nullable)
//   status: text (nullable)
//   data_abertura: timestamp without time zone (nullable, default: now())
//   created_at: timestamp without time zone (nullable, default: now())
// Table: photos
//   id: uuid (not null, default: gen_random_uuid())
...
//   completion_percentage: numeric (nullable, default: 0)
//   status: text (nullable)
...
//   address: text (nullable)
//   technical_responsible: text (nullable)
//   art_number: text (nullable)
//   start_date: date (nullable)
//   end_date: date (nullable)
//   total_value: numeric (nullable, default: 0)
//   status: project_status (nullable, default: 'planejamento'::project_status)
//   created_at: timestamp with time zone (nullable, default: now())
//   updated_at: timestamp with time zone (nullable, default: now())
...
// Table: etapas_obra
//   FOREIGN KEY etapas_obra_obra_id_fkey: FOREIGN KEY (obra_id) REFERENCES obras(id)
//   PRIMARY KEY etapas_obra_pkey: PRIMARY KEY (id)
// Table: inventory
...
// Table: obras
//   PRIMARY KEY obras_pkey: PRIMARY KEY (id)
// Table: ordens_servico
//   FOREIGN KEY ordens_servico_contrato_id_fkey: FOREIGN KEY (contrato_id) REFERENCES contratos(id)
//   PRIMARY KEY ordens_servico_pkey: PRIMARY KEY (id)
// Table: photos
...
// Table: project_finance
//   PRIMARY KEY project_finance_pkey: PRIMARY KEY (id)
//   FOREIGN KEY project_finance_project_id_fkey: FOREIGN KEY (project_id) REFERENCES projects(id) ON DELETE CASCADE
// Table: project_stages
//   CHECK project_stages_completion_percentage_check: CHECK (((completion_percentage >= (0)::numeric) AND (completion_percentage <= (100)::numeric)))
...
//   FOREIGN KEY project_stages_responsible_id_fkey: FOREIGN KEY (responsible_id) REFERENCES users(id) ON DELETE SET NULL
// Table: projects
//   FOREIGN KEY projects_client_id_fkey: FOREIGN KEY (client_id) REFERENCES clients(id) ON DELETE RESTRICT
...
// Table: checklists
//   Policy "auth_select_checklists" (SELECT, PERMISSIVE) roles={authenticated}
//     USING: true
// Table: clients
//   Policy "auth_all_clients" (ALL, PERMISSIVE) roles={authenticated}
//     USING: true
//     WITH CHECK: true
//   Policy "auth_select_clients" (SELECT, PERMISSIVE) roles={authenticated}
//     USING: true
...
//     WITH CHECK: true
// Table: contratos
//   Policy "liberar contratos" (ALL, PERMISSIVE) roles={public}
//     USING: true
//     WITH CHECK: true
// Table: etapas_obra
//   Policy "liberar etapas" (ALL, PERMISSIVE) roles={public}
//     USING: true
//     WITH CHECK: true
// Table: measurements
...
//     WITH CHECK: true
// Table: obras
//   Policy "liberar obras" (ALL, PERMISSIVE) roles={public}
//     USING: true
//     WITH CHECK: true
// Table: ordens_servico
//   Policy "liberar os" (ALL, PERMISSIVE) roles={public}
//     USING: true
//     WITH CHECK: true
// Table: photos
//   Policy "auth_all_photos" (ALL, PERMISSIVE) roles={authenticated}
//     USING: true
//     WITH CHECK: true
// Table: project_finance
//   Policy "auth_all_project_finance" (ALL, PERMISSIVE) roles={authenticated}
//     USING: true
//     WITH CHECK: true
// Table: project_stages
//   Policy "auth_all_project_stages" (ALL, PERMISSIVE) roles={authenticated}
//     USING: true
//     WITH CHECK: true
// Table: projects
...
//     WITH CHECK: true
// Table: roles
//   Policy "auth_select_roles" (SELECT, PERMISSIVE) roles={authenticated}
//     USING: true
// Table: service_categories
//   Policy "auth_all_sc" (ALL, PERMISSIVE) roles={authenticated}
//     USING: true
//     WITH CHECK: true
//   Policy "auth_select_service_categories" (SELECT, PERMISSIVE) roles={authenticated}
//     USING: true
// Table: service_order_items
...
//     WITH CHECK: true
// Table: service_orders
//   Policy "auth_all_service_orders" (ALL, PERMISSIVE) roles={authenticated}
//     USING: true
//     WITH CHECK: true
...
//     USING: true
//     WITH CHECK: true
//   Policy "auth_select_service_types_config" (SELECT, PERMISSIVE) roles={authenticated}
//     USING: true
// Table: sla_definitions
//   Policy "auth_all_sla" (ALL, PERMISSIVE) roles={authenticated}
//     USING: true
//     WITH CHECK: true
//   Policy "auth_select_sla_definitions" (SELECT, PERMISSIVE) roles={authenticated}
//     USING: true
// Table: stock_movements
...
//     USING: true
//     WITH CHECK: true
//   Policy "auth_select_system_parameters" (SELECT, PERMISSIVE) roles={authenticated}
//     USING: true
// Table: teams
//   Policy "auth_select_teams" (SELECT, PERMISSIVE) roles={authenticated}
//     USING: true
// Table: technicians
//   Policy "auth_all_technicians" (ALL, PERMISSIVE) roles={authenticated}
//     USING: true
//     WITH CHECK: true
//   Policy "auth_select_technicians" (SELECT, PERMISSIVE) roles={authenticated}
//     USING: true
// Table: units
//   Policy "auth_all_units" (ALL, PERMISSIVE) roles={authenticated}
//     USING: true
//     WITH CHECK: true
//   Policy "auth_select_units" (SELECT, PERMISSIVE) roles={authenticated}
//     USING: true
// Table: users
//   Policy "auth_all_users" (ALL, PERMISSIVE) roles={authenticated}
//     USING: true
//     WITH CHECK: true
//   Policy "auth_select_users" (SELECT, PERMISSIVE) roles={authenticated}
//     USING: true
...
//   CREATE INDEX idx_so_scheduled_at ON public.service_orders USING btree (scheduled_at)
